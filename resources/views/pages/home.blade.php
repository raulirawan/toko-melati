                                    ...
                                    <div class="product">
                                        ...
                                        <div class="product-body">
                                            ...
                                            <div class="product-btns">
                                                ...
                                                <button class="" onclick="window.open('{{ $item->tokopedia }}','_blank')" type="button"><i class="fa tokopedia"></i><span class="tooltipp">Link Tokopedia</span>
                                                </button>
                                                <button class="" onclick="window.open('{{ route('product.detail', $item->slug) }}','_blank')" type="button"><i class="fa fa-eye"></i><span class="tooltipp">Detail Produk</span>
                                                </button>
                                            </div>
                                        </div>
                                        <div class="add-to-cart">
                                            {{-- <button class="add-to-cart-btn" onclick="window.open('{{ route('product.detail', $item->slug) }}><i class="fa fa-shopping-cart"></i> add to cart</button> --}}
                                            <button class="add-to-cart-btn" onclick="window.open('{{ route('product.detail', $item->slug) }}','_blank')" type="button"><i class="fa fa-shopping-cart"></i> add to cart</button>
                                            {{-- <form action="{{ route('add.to.cart.instant', $item->id) }}" method="POST">
                                                @csrf
